...
import time
import unittest
from smolregrtest.cmdline import _parse_args
from smolregrtest.runtest import (
    findtests,
    runtest,
    get_abs_module,
    is_failed,
...
from smolregrtest.setup import setup_tests
from smolregrtest.utils import removepy, count, format_duration, printlist
...
class Regrtest:
    ...
    def parse_args(self, kwargs):
        ...
        ns.worker_args
        # TODO: To be removed (jfh)
        """
        if worker_args is not None:
            from smolregrtest.runtest_mp import parse_worker_args
    ...
    def run_tests(self):
        ...
        if self.ns.use_mp:
            # TODO: Removed by me, only want sequential (jfh)
            """
            from smolregrtest.runtest_mp import run_tests_multiprocess
    ...
    def _main(self, tests, kwargs):
        if self.worker_test_name is not None:
            # TODO: Removed by me (jfh), don't need mp test running
            """
            from smolregrtest.runtest_mp import run_tests_worker
