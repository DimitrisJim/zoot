...
from smolregrtest.cmdline import Namespace
from smolregrtest.save_env import saved_test_environment
from smolregrtest.utils import clear_caches, format_duration, print_warning
...
def _runtest_inner2(ns: Namespace, test_name: str) -> bool:
    ...
    if ns.huntrleaks:
        # TODO: Removed by me (jfh), don't need to worry about refleaks.
        """
